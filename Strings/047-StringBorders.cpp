//String Borders
//Determines the longest substring that isn't the entire string, such that it is both a prefix (ab is a prefix of abcde) and a suffix (de is a suffix of abcde).
